...
export compact_state!, compact_state_logical!
...
export qrom_lookup_xor_cache_size, qrom_lookup_xor_cache_max_size,
       set_qrom_lookup_xor_cache_size!, clear_qrom_lookup_xor_cache!
