...
# After Phase C2 (ctrls kwarg refactor), c_mul=2 fits under Orkan's
# 30-qubit cap at N=15 cpad=1.

# Phase A: smoke shot — verify the end-to-end path runs at N=15 c_mul=2.
